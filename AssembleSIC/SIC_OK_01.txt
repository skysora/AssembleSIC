...
RLOOP   TD      INPUT    TEST INPUT DEVICE
        ...
        COMP    ZERO     TEST FOR ENF OF RECORD (X'00')
        JEQ     EXIT     EXIT LOOP IF EOR
        STCH    BUFFER,X STORE CHARATER IN BUFFER
        TIX     MAXLEN   LOOP UNLESS MAX LENGTH
        JLT     RLOOP      HAS BEEN REACHED
EXIT    STX     LENGTH   SAVE RECORD LENGTH
        RSUB             RETURN TO CALLER
INPUT   BYTE    X'F1'    CODE FOR TNPUT DEVICE
MAXLEN  WORD    4096
.
...
WLOOP   TD      OUTPUT   TEST OUTPUT DEVICE
        ...
        TIX     LENGTH   LOOP UNTIL ALL CHARACTER
        RSUB               HAVE BEEN WRITTEN
OUTPUT  BYTE    X'05'    RETURN TO CALLER
        END     FIRST